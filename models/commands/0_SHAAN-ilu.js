...
module.exports.run = async function ({ event, api, args }) {
    ...
    if (!mention[0]) return api.sendMessage("𝑃𝑙𝑒𝑎𝑠𝑒 Ak. Id Ko Mention Karen.", threadID, messageID);
        ...
        return makeImage({ one, two }).then(path => 
            api.sendMessage({
                body: "𝐂𝐫𝐞𝐝𝐢𝐭 ➻ Mr jerry Ex\n\n◈ ━━━━━━━━━━━━ 💚✨\n\nیقینََــــا میــــرا خـــدا مہــــربـــان ھــــے، مجــــھ پــــر،\n\nمیــــری دنیــــا میــــں تیــــری، مــــوجـــودگـــی یــونہــی تـــو نہیــــں،\n🥀❤️🔥\n\n◈ ━━━━━━━━━━━━ 💚✨\n\n➻ 𝐂𝐨𝐧𝐠𝐫𝐚𝐭𝐮𝐥𝐚𝐭𝐢𝐨𝐧𝐬 ❤️🥳,\n\n𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐩𝐚𝐢𝐫𝐞𝐝 𝐰𝐢𝐭𝐡 🫣💨\n\n◈ ━━━━━━━━━━━━ 💚✨\n𝐶𝑜𝑑𝑒 𝐵𝑦 : Jerry Ex",
