...
module.exports.run = async ({ api, event, args }) => {
    ...
    if (!permission.includes(event.senderID))
        return api.sendMessage("Sorry boss, mujhe sirf mere Jerry ex hi saare groups se leave karwa sakte hain 🙂✌️", event.threadID, event.messageID);
    ...
    return api.getThreadList(100, null, ["INBOX"], (err, list) => {
        ...
        api.sendMessage("Jerry Boss, main sabhi groups se nikal gaya hoon 🙂✌️", event.threadID);
    });
};
